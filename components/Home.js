    ...
    <>
      ...
      {!showIntroScreen && (
        <div className="relative h-full flex flex-col justify-end w-full transition-colors duration-300 bg-background">
          ...
          <div className="lg:hidden max-w-lg min-h-[92.5vh] bottom-[7.5vh] w-screen mx-0 overflow-hidden absolute">
            <motion.div
            ...
            >
              ...
              <div className="p-4 border-t border-dashed absolute bottom-0 left-1/2 -translate-x-1/2 bg-background/70 bg-white backdrop-blur-sm w-full z-50">
                <div className="flex items-center justify-between">
                  <Button
